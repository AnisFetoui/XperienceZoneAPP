...
public class ModifierProduitController implements Initializable {
    ...
    private void modifierProduit(ActionEvent event) {
        if (selectedProduit != null) {
            ...
            String nouveauType = choixpmodif.getValue();
            ...
            selectedProduit.setCategorie(new Categorie(nouveauType));
    ...
    private List<String> loadCategoriesFromDataSource() {
    
        // Simule le chargement de catégories depuis une source de données
