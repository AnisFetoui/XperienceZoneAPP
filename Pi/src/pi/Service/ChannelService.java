...
public class ChannelService implements IChannel{
    ...
    public List<Channel> findAll() {
        ...
        try {
            preparedStatement = connection.prepareStatement(sql);  //stay t7athr req bad t'excute , preapr t3adiha direct mn ghir ma t7athr 
  ...
  public Boolean checkIfExist(String nomChannel){
    ...
    public void save(Channel channel) {
        System.out.println(channel.getEvenement().getIdEvenement());
        ...
        try {
            ...
            preparedStatement.setInt(2, channel.getEvenement().getIdEvenement());
