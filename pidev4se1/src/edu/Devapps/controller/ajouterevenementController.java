...
public class ajouterevenementController implements Initializable {
    ...
    private void ajouterevenement(ActionEvent event) throws IOException {
        ...
        ip= Integer.parseInt(nb_par.getText());
        Date sqlDate= new Date(date1.getValue().getYear(), date1.getValue().getMonthValue(), date1.getValue().getDayOfMonth());
          c.ajouterevenement(new Evenement(1,nom.getText(), description.getText(), sqlDate,heure.getText(),lieu.getText(),ip,image.getText(),organizateur.getText()));
